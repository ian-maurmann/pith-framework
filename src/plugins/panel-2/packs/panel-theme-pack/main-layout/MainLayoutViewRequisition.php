...
class MainLayoutViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        $this->addStylesheet('OxCSS stylesheet',  '/resources/vendor/library/oxcss/oxcss-0.1.4/dist/ox.css', 'library-for-layout');
        $this->addStylesheet('Swal2 NA stylesheet', '/resources/vendor/library/sweetalert/swal2-no-anthems-11.7.3/swal2-na.css', 'library-for-layout');
        $this->addStylesheet('Re-style Swal2', '/resources/vendor/library/sweetalert/swal2-custom-themes/swal2-aerogel-theme.css', 'library-for-layout');
        ...
        $this->addScript('OxCSS script','/resources/vendor/library/oxcss/oxcss-0.1.4/dist/ox.js', 'library-for-layout');
        $this->addScript('Swal2 NA script', '/resources/vendor/library/sweetalert/swal2-no-anthems-11.7.3/swal2-na.all.js', 'library-for-layout');
