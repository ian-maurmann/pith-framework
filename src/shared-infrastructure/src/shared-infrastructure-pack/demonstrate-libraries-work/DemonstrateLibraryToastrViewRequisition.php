...
class DemonstrateLibraryToastrViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        // Resources
        $this->addStylesheet('Toastr - CSS', '/resources/vendor/common-libraries/toastr/build/toastr.css', 'library-for-page');
        $this->addScript('jquery', '/resources/vendor/common-libraries/jquery-3.6.4/jquery-3.6.4.min.js', 'library-for-page');
        $this->addScript('Toastr - JavaScript', '/resources/vendor/common-libraries/toastr/build/toastr.min.js', 'library-for-page');
    }
}