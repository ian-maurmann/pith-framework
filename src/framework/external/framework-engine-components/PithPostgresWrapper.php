...
/**
 * Pith Database Wrapper for PostgreSQL using PDO
 * ----------------------------------------------
 *
 */
...
class PithPostgresWrapper
{
    ...
    public function getStatus(): string
    {
        ...
        if ($this->did_connect) {
            $status = 'Connected to host. Status: ' . $this->pdo->getAttribute(PDO::ATTR_CONNECTION_STATUS);
        }
