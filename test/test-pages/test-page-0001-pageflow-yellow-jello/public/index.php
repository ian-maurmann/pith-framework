...
// Load our Constants
// require 'test/test-pages/test-page-0001-pageflow-yellow-jello/src/constants.php'; // Enter the path to constants file.
...
if($pith) {
    ...
    $pith->config->env_constants_file = 'test/test-pages/test-page-0001-pageflow-yellow-jello/env.php';
