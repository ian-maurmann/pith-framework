...
class DemonstrateLibraryToastrViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        // Resources
        $this->addStylesheet('Toastr - CSS', '/resources/vendor/common-libraries/toastr/toastr-2.1.4/build/toastr.css', 'library-for-page');
        $this->addScript('jquery', '/resources/vendor/common-libraries/jquery/jquery-3.6.4/jquery-3.6.4.min.js', 'library-for-page');
        $this->addScript('Toastr - JavaScript', '/resources/vendor/common-libraries/toastr/toastr-2.1.4/build/toastr.min.js', 'library-for-page');
    }
}