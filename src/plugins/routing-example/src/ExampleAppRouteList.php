...
class ExampleAppRouteList extends PithRouteList
{
    public array $routes = [
     ...
     // ['route',       'POST',          PITH_APP_DEFAULT_LOGIN_FORM_ACTION_LINK,                       '\\Pith\\Framework\\SharedInfrastructure\\Pages\\SharedUiPages\\PerformUserLoginRoute'],
        ['route',       'POST',          PITH_APP_DEFAULT_LOGIN_FORM_ACTION_LINK,                       '\\Pith\\Framework\\Plugin\\Session\\PerformUserLoginRoute'],
