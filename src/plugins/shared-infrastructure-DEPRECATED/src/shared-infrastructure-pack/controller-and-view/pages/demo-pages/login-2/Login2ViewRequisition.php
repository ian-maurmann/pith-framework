...
/**
 * Class Login2ViewRequisition
 */
class Login2ViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        $this->addStylesheet( 'Login stylesheet', '/resources/framework/plugin/login-form/login.css', 'application-for-page');
        ...
        $this->addScript(     'Login script', '/resources/framework/plugin/login-form/login.js', 'application-for-page');
