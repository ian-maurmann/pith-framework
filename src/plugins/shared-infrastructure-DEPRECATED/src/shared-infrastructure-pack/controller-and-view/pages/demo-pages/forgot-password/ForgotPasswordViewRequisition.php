...
/**
 * Forgot Password view-requisition
 * --------------------------------
 *
...
/**
 * Class ForgotPasswordViewRequisition
 */
class ForgotPasswordViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        // App CSS
        $this->addStylesheet( 'Forgot Password stylesheet', '/resources/framework/plugin/forgot-password/forgot-password.css', 'application-for-page');

        // App JS
        $this->addScript(     'Forgot Password script', '/resources/framework/plugin/forgot-password/forgot-password.js', 'application-for-page');
