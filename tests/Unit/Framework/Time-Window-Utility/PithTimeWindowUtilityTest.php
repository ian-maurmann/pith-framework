...
test('Time Window Utility :: get12MinuteWindowStartDatetime( ) will be 00 in 1st 12min window of hour.', function () {
    $time_window_utility = new Pith\Framework\Internal\PithTimeWindowUtility();
...
test('Time Window Utility :: get12MinuteWindowStartDatetime( ) will be 12 in 2nd 12min window of hour.', function () {
    $time_window_utility = new Pith\Framework\Internal\PithTimeWindowUtility();
...
test('Time Window Utility :: get12MinuteWindowStartDatetime( ) will be 24 in 3rd 12min window of hour.', function () {
    $time_window_utility = new Pith\Framework\Internal\PithTimeWindowUtility();
...
test('Time Window Utility :: get12MinuteWindowStartDatetime( ) will be 36 in 4th 12min window of hour.', function () {
    $time_window_utility = new Pith\Framework\Internal\PithTimeWindowUtility();
...
test('Time Window Utility :: get12MinuteWindowStartDatetime( ) will be 48 in 5th 12min window of hour.', function () {
    $time_window_utility = new Pith\Framework\Internal\PithTimeWindowUtility();
