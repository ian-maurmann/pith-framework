...
// Special Access IPs
const PITH_APP_DEV_ACCESS_IP_ADDRESSES  = [];
const PITH_APP_CRON_ACCESS_IP_ADDRESSES = [];
...
const PITH_TASK_SHELL_COMMAND_FORMAT = ''; // TODO: Might get rid of this soon, if possible
