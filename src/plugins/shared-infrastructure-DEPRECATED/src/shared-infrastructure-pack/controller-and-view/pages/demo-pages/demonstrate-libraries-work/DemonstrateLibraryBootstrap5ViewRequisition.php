...
class DemonstrateLibraryBootstrap5ViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        // Resources
        $this->addStylesheet('Bootstrap 5 stylesheet', '/resources/vendor/common-libraries/bootstrap/bootstrap-5.3.0-alpha3-dist/css/bootstrap.min.css', 'library-for-page');
        ...
        $this->addScript('Bootstrap 5 Bundle script', '/resources/vendor/common-libraries/bootstrap/bootstrap-5.3.0-alpha3-dist/js/bootstrap.bundle.min.js', 'library-for-page');
    }
}