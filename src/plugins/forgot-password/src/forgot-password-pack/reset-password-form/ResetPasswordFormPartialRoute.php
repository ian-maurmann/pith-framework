...
/**
 * Reset Password Form Partial Route
 * ---------------------------------
 *
...
/**
 * Class ResetPasswordFormPartialRoute
 */
class ResetPasswordFormPartialRoute extends PithRoute
{
    public string $route_type   = 'partial';
    public string $pack         = '\\Pith\\Framework\\Plugin\\ForgotPassword\\PithForgotPasswordPack';
    public string $access_level = 'world';
    public string $view         = '[^route_folder]/reset-password-form-partial-view.phtml';
