...
/**
 * %[^PROJECT_MAIN_TITLE]% App Route-List
 * %[^PROJECT_MAIN_TITLE_UNDERLINE]%───────────────
 *
...
/**
 * Class %[^PROJECT_MAIN_TITLE_IN_PHP]%AppRouteList
 */
class %[^PROJECT_MAIN_TITLE_IN_PHP]%AppRouteList extends PithRouteList
{
    public array $routes = [
