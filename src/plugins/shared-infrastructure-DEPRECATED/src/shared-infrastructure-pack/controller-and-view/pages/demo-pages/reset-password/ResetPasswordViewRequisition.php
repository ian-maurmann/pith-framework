...
/**
 * Reset Password view-requisition
 * -------------------------------
 *
...
/**
 * Class ResetPasswordViewRequisition
 */
class ResetPasswordViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        // App CSS
        $this->addStylesheet( 'Reset Password stylesheet', '/resources/framework/plugin/forgot-password/reset-password.css', 'application-for-page');

        // App JS
        $this->addScript(     'Reset Password script', '/resources/framework/plugin/forgot-password/reset-password.js', 'application-for-page');
