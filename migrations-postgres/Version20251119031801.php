...
/**
 * Migration to populate access levels table
 * -----------------------------------------
 *
 ...
 * Migration
 */
final class Version20251119031801 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Populate table pith_access_levels.';
    }
    ...
    public function down(Schema $schema): void
    {
        $this->addSql(
            /** @lang PostgreSQL */
            'DELETE FROM pith_access_levels WHERE access_level_id IN 
            (100, 101, 102, 103, 200, 201, 300, 301, 302, 400, 500, 600, 700, 800)
        ');
    }
}
