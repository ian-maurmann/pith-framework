...
|-----------------------|-----------|-------------|-------------|---------------|----------------|---------|------------------------------------------------------------------------------------|
| Alpha 61              | 0.9.3.2   | *sv 0.46.0* | 8.5         | PostgreSQL 18 | 2026-08-15     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
...
| Alpha 57              | 0.9.1.0   | *sv 0.41.0* | 8.4         | MariaDB       | 2025-06-02     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| Alpha 56              | 0.9.0.5   | *sv 0.40.0* | 8.4         | MariaDB       | 2025-04-22     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| Alpha 55              | 0.9.0.4   | *sv 0.39.0* | 8.4         | MariaDB       | 2025-03-08     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| Alpha 54              | 0.9.0.3   | *sv 0.38.0* | 8.4         | MariaDB       | 2025-02-22     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| Alpha 53              | 0.9.0.2   | *sv 0.37.0* | 8.4         | MariaDB       | 2025-02-14     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| FC 2                  | 0.9.0.1   | *sv 0.36.0* | PHP 8.4     | MariaDB       | 2025-01-03     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| FC                    | 0.9.0.0   | *sv 0.35.3* | 8.3         | MariaDB       | 2024-10-12     | MPL 2   | Has all the features that are needed, but some features are still being re-worked. |
| Alpha 52              | 0.8.9.2   | *sv 0.35.2* | 8.3         | MariaDB       | 2024-09-28     | MPL 2   | Usable, but reworking the feature set                                              |
| Alpha 51              | 0.8.9.1   | *sv 0.35.1* | 8.3         | MariaDB       | 2024-05-25     | MPL 2   | Usable, but reworking the feature set                                              |
| Alpha 50              | 0.8.9.0   | *sv 0.35.0* | PHP 8.3     | MariaDB       | 2024-04-09     | MPL 2   | Usable, but reworking the feature set                                              |
| Alpha 49              | 0.8.8.3   | *sv 0.34.0* | 8.2+        | MariaDB       | 2024-03-19     | MPL 2   | Usable, but reworking the feature set                                              |
| Alpha 48              | 0.8.8.2   | *sv 0.33.0* | 8.2+        | MariaDB       | 2024-03-09     | MPL 2   | Usable, but reworking the feature set                                              |
| Alpha 47              | 0.8.8.1   | *sv 0.32.0* | 8.2+        | MariaDB       | 2024-02-06     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 46              | 0.8.8.0   | *sv 0.31.0* | 8.2+        | MariaDB       | 2024-01-27     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 45              | 0.8.7.0   | *sv 0.30.1* | 8.2         | MariaDB       | 2023-11-14     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 44              | 0.8.6.2   | *sv 0.30.0* | 8.2         | MariaDB       | 2023-08-10     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 43              | 0.8.6.1   | *sv 0.29.0* | 8.2         | MariaDB       | 2023-07-10     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 42              | 0.8.6.0   | *sv 0.28.0* | 8.2         | MariaDB       | 2023-06-30     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 41              | 0.8.5.1   | *sv 0.27.0* | PHP 8.2     | MariaDB       | 2023-05-13     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 40              | 0.8.5.0   | *sv 0.26.0* | 8.1+        | MariaDB       | 2023-04-18     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 39              | 0.8.4.0   | *sv 0.25.0* | 8.1+        | MariaDB       | 2023-01-18     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 38              | 0.8.3.1   | *sv 0.24.0* | 8.1+        | MariaDB       | 2022-12-17     | MPL 2   | Usable, but still adding new features                                              |
| Alpha 37              | 0.8.3.0   | *sv 0.23.0* | 8.1+        | MariaDB       | 2022-12-10     | MPL 2   | Stable, limited features                                                           |
| Alpha 36              | 0.8.2.0   | *sv 0.22.0* | 8.1         | MariaDB       | 2022-12-03     | MPL 2   | Stable, limited features                                                           |
| Alpha 35              | 0.8.1.1   | *sv 0.21.0* | 8.1         | MariaDB       | 2022-11-22     | MPL 2   | Stable, limited features                                                           |
| Alpha 34              | 0.8.1.0   | *sv 0.20.0* | 8.1         | MariaDB       | 2022-11-01     | MPL 2   | Stable, limited features                                                           |
| Alpha 33              | 0.8.0.1   | *sv 0.19.0* | 8.1         | MariaDB       | 2022-06-14     | MPL 2   | Stable, limited features                                                           |
| Alpha 32              | 0.8.0.0   | *sv 0.18.0* | PHP 8.1     | MariaDB       | 2022-05-28     | MPL 2   | Stable, limited features                                                           |
| Alpha 31              | 0.7.5.0   | *sv 0.17.0* | 7.1+        | MariaDB       | 2022-01-25     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 30              | 0.7.4.0   | *sv 0.16.0* | 7.1+        | MariaDB       | 2021-02-16     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 29              | 0.7.3.0   | *sv 0.15.0* | 7.1+        | MariaDB       | 2020-11-21     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 28              | 0.7.2.0   | *sv 0.14.0* | 7.1+        | MariaDB       | 2020-07-28     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 27              | 0.7.1.1   | *sv 0.13.0* | 7.1+        | MariaDB       | 2020-06-20     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 26              | 0.7.1.0   | *sv 0.12.0* | 7.1+        | MariaDB       | 2020-03-10     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 25              | 0.7.0.2   | *sv 0.11.0* | 7.1+        | MariaDB       | 2020-03-03     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 24              | 0.7.0.1   | *sv 0.10.0* | 7.1+        | MariaDB       | 2020-02-25     | MPL 2   | Stable, but not production-ready                                                   |
| Alpha 23              | 0.7.0.0   | *sv 0.9.1*  | 7.1+        | MariaDB       | 2020-01-28     | MPL 2   | (MVP) Stable, but not production-ready                                             |
| Rewrite UF            | 0.6.5.0   | *sv 0.9.0*  | 7.1+        | MariaDB       | 2019-11-20     | MPL 2   | :warning: *Testing and experimentation.*                                           |
| Rewrite Pre-Alpha 8   | 0.6.4.0   | *sv 0.8.0*  | 7.1+        | MariaDB       | 2019-11-05     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 7   | 0.6.3.0   | *sv 0.7.0*  | 7.1+        | MariaDB       | 2019-10-29     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 6   | 0.6.2.1   | *sv 0.6.1*  | 7.1+        | MariaDB       | 2019-09-24     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 5   | 0.6.2.0   | *sv 0.6.0*  | 7.1+        | MariaDB       | 2019-07-09     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 4   | 0.6.1.0   | *sv 0.5.0*  | 7.1+        | MariaDB       | 2019-05-27     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 3   | 0.6.0.3   | *sv 0.4.0*  | 7.1+        | MariaDB       | 2019-03-23     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 2   | 0.6.0.2   | *sv 0.3.0*  | 7.1+        | MariaDB       | 2018-11-20     | MPL 2   | :warning: *Not yet*                                                                |
| Rewrite Pre-Alpha 1   | 0.6.0.1   | *sv 0.2.0*  | 7.1+        | MariaDB       | 2018-10-30     | MPL 2   | :warning: *Not yet*                                                                |
| (2nd) Initial Rewrite | 0.6.0.0   | *sv 0.1.0*  | PHP 7.1     | MariaDB       | 2018-10-23     | MPL 2   | :warning: *Not yet*                                                                |
| Alpha 22              | 0.5.7.2   |             | 5.3+        | MySQL         | 2015-04-02     | MPL 1.1 | (Old)                                                                              |
| Alpha 21              | 0.5.6.6   |             | 5.3+        | MySQL         | 2014-09-06     | MPL 1.1 | ((Old)                                                                             |
| Alpha 20              | 0.5.6.5   |             | 5.3+        | MySQL         | 2014-04-12     | MPL 1.1 | ((Old)                                                                             |
| Alpha 19              | 0.5.6.4   |             | 5.3+        | MySQL         | 2014-03-11     | MPL 1.1 | ((Old)                                                                             |
| Alpha 18              | 0.5.6.3   |             | 5.3+        | MySQL         | 2013-10-06     | MPL 1.1 | ((Old)                                                                             |
| Alpha 17              | 0.5.6.2   |             | 5.3+        | MySQL         | 2013-09-20     | MPL 1.1 | ((Old)                                                                             |
| Alpha 16              | 0.5.6.1   |             | 5.3+        | MySQL         | 2013-09-17     | MPL 1.1 | ((Old)                                                                             |
| Alpha 15              | 0.5.6.0   |             | 5.3+        | MySQL         | 2013-08-29     | MPL 1.1 | ((Old)                                                                             |
| Alpha 14              | 0.5.5.0   |             | 5.3+        | MySQL         | 2013-05-03     | MPL 1.1 | ((Old)                                                                             |
| Alpha 13              | 0.5.4.0   |             | 5.3+        | MySQL         | 2013-04-11     | MPL 1.1 | ((Old)                                                                             |
| Alpha 12              | 0.5.3.0   |             | 5.3+        | MySQL         | 2013-01-10     | MPL 1.1 | ((Old)                                                                             |
| Alpha 11              | 0.5.2.1   |             | 5.3+        | MySQL         | 2012-04-16     | MPL 1.1 | ((Old)                                                                             |
| Alpha 10              | 0.5.1.0   |             | 5.3+        | MySQL         | 2012-03-05     | MPL 1.1 | ((Old)                                                                             |
| Alpha 9               | 0.5.0.2   |             | 5.3         | MySQL         | 2012-02-22     | MPL 1.1 | ((Old)                                                                             |
| Alpha 8               | 0.5.0.1   |             | 5.3         | MySQL         | 2012-02-14     | MPL 1.1 | ((Old)                                                                             |
| Alpha 7               | 0.5.0.0   |             | 5.3         | MySQL         | 2012-02-13     | MPL 1.1 | ((Old)                                                                             |
| Alpha 6 (v2)          | 0.4.3.1v2 |             | 5.3         | MySQL         | 2012-02-07     | MPL 1.1 | ((Old)                                                                             |
| Alpha 6               | 0.4.3.1   |             | 5.3         | MySQL         | 2011-09-23     | MPL 1.1 | ((Old)                                                                             |
| Alpha 5               | 0.4.3.0   |             | 5.3         | MySQL         | 2011-08-01     | MPL 1.1 | ((Old)                                                                             |
| Alpha 4               | 0.4.2.0   |             | 5.3         | MySQL         | 2011-05-25     | MPL 1.1 | ((Old)                                                                             |
| Alpha 3               | 0.4.1.3   |             | 5.3         | MySQL         | 2011-03-24     | MPL 1.1 | ((Old)                                                                             |
| Alpha 2               | 0.4.1.2   |             | 5.3         | MySQL         | 2011-02-16     | MPL 1.1 | ((Old)                                                                             |
| Alpha 1 (v2)          | 0.4.1.1v2 |             | 5.3         | MySQL         | 2011-01-25     | MPL 1.1 | ((Old)                                                                             |
| Alpha 1               | 0.4.1.1   |             | 5.3         | MySQL         | 2011-01-17     | MPL 1.1 | ((Old)                                                                             |
| Initial Release       | 0.4.1.0   |             | 5.3         | MySQL         | 2010-12-29     | MPL 1.1 | ((Old)                                                                             |
| Second Pre-Alpha 2    | 0.4.0.2   |             | 5.3         | MySQL         | 2010-11-29     |         | ((Old)                                                                             |
| Second Pre-Alpha 1    | 0.4.0.1   |             | 5.3         | MySQL         | 2010-06-17     |         | ((Old)                                                                             |
| Initial Rewrite       | 0.4.0.0   |             | PHP 5.3     | MySQL         | 2010-06-08     |         | ((Old)                                                                             |
...
**0.9.3.2 - Alpha 61** `(semver: 0.46.0)`
- Added new plugin for Forgot-Password / Password-Reset.
- Remove database migrations for old database.
...
**0.9.2.1 - Alpha 58 part 2** `(semver: 0.43.0)`
- Update the new install setup to use Postgres.

**0.9.2.0 - Alpha 58** `(semver: 0.42.0)`
- Switched to using Postgres 18 as the database.

**0.9.1.0 - Alpha 57** `(semver: 0.41.0)`
- Added new install setup.
...
**0.9.0.2 - Alpha 53** `(semver: 0.37.0)`
- Small updates. Getting started on new CLI tool.
- Upgraded dependencies.
