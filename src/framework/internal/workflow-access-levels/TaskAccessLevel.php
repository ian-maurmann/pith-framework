...
/**
 * Class CronIpAccessLevel
 * @package Pith\Framework\Internal
 */
class TaskAccessLevel extends PithAccessLevel
{
    ...
    public function isAllowedToAccess(): bool
    {
        ...
        // Get if is the task tool
        $is_task_tool = $app->process->process_type === 'task' && $app->process->boundary_type === 'task-tool';
