...
/**
 * Class DemonstrateLibraryHojaViewRequisition
 * @package Pith\Framework\SharedInfrastructure
 */
class DemonstrateLibraryHojaViewRequisition extends PithViewRequisition
{
    ...
    public function runRequisition()
    {
        ...
        // Resources
        $this->addStylesheet('Hoja Double Ring stylesheet', '/resources/vendor/common-libraries/hoja/hoja-double-ring/hoja-double-ring.css', 'library-for-page');
    }
}