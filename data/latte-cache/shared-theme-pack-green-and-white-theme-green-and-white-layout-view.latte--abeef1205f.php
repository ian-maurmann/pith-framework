...
final class Templateabeef1205f extends Latte\Runtime\Template
{
...
<html lang="en">
    <head>
        ...
        ';
		echo LR\Filters::escapeHtmlText(($this->global->fn->insertResourceFiles)(2)) /* line 24 */;
		echo '
    </head>
    <body>
        <div id="banner-area">
            ...
            <nav>
                ';
		echo LR\Filters::escapeHtmlText(($this->global->fn->insertPartial)('Pith\\Framework\\SharedInfrastructure\\DemoNavLinksPartialRoute')) /* line 30 */;
		echo '
            </nav>
        </div>
        <div id="content-area">
            ...
            <div id="footer">
                ';
		echo LR\Filters::escapeHtmlText(($this->global->fn->insertPartial)('Pith\\Framework\\SharedInfrastructure\\FooterRoute')) /* line 42 */;
		echo '
            </div>
        </div>
